...
exports.applyTransformToPoint = void 0;
/**
...
function applyTransformToPoint(point, transform) {
    ...
    const x = scale * (Math.cos(angle) * point[0] - Math.sin(angle) * point[1]) +
        xTranslation;
    const y = scale * (Math.sin(angle) * point[0] + Math.cos(angle) * point[1]) +
        yTranslation;
    return [x, y];
}
exports.applyTransformToPoint = applyTransformToPoint;
//# sourceMappingURL=applyTransformToPoint.js.map